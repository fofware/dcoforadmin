...
COPY index.html /webroots/admin.firulais.net.ar/

RUN mkdir -p /webroots/admin.firulais.net.ar/.well-known/acme-challenge

RUN mkdir -p /webroots/firulais.net.ar/.well-known/acme-challenge
